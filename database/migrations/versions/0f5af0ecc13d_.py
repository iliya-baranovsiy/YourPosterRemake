...
def upgrade() -> None:
    ...
    op.create_index('channels_settings_index', 'ChannelsSettings', ['channel_id'], unique=False)
    ...
    op.create_index('channels_times_index', 'PostsTimes', ['channel_id', 'time'], unique=False)
    ...
    op.create_index('channel_file_data_index', 'file_user_storage', ['channel_id'], unique=False)
    ...
    op.create_index('channel_ai_data_index', 'generate_user_storage', ['channel_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('channel_ai_data_index', table_name='generate_user_storage')
    op.drop_table('generate_user_storage')
    op.drop_index('channel_file_data_index', table_name='file_user_storage')
    op.drop_table('file_user_storage')
    op.drop_index('channels_times_index', table_name='PostsTimes')
    ...
    op.drop_index('channels_settings_index', table_name='ChannelsSettings')
