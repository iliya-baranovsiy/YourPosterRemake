...
class KeyboardBuilder:
    ...
    def create_settings_button(self, channel_id: int):
        self.kb.append([InlineKeyboardButton(text="Настройки постинга", callback_data=f"settings_{channel_id}")])

    def create_delete_button(self, channel_id: int):
        self.kb.append(
            [InlineKeyboardButton(text="Отвязать канал", callback_data=f"delete_{channel_id}")])
